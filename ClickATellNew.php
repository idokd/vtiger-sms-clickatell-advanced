...
class SMSNotifier_ClickATellNew_Provider implements SMSNotifier_ISMSProvider_Model {
        ...
        private static $SKIPPED_PARAMS = array('callback', 'from' );
        
        private $API_URI = 'https://platform.clickatell.com/messages';
        private static $REQUIRED_PARAMETERS = array(array('name'=>'callback','label'=>'Enable delivery notifications URL','type'=>'url'),array('name'=>'api_key','label'=>'API Key','type'=>'text'), array( 'name' => 'from', 'label' => 'From', 'type' => 'text' );
